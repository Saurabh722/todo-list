(function (window) {
	...
	function Controller(model, view) {
		...
		that.view.bind('itemDelete', function (id) {
			that.itemDelete(id);
		});
	}
	...
	Controller.prototype.showCompleted = function () {
		var that = this;
		that.model.read({ completed: true }, that.showAll);
	};
	...
	/**
	 * Give it an ID of a model and it will delte the item in storage.
	 *
	 * @param {number} id The ID of the element to complete or uncomplete
	 */
	Controller.prototype.itemDelete = function (id) {
		var that = this;
		that.model.deleteItem(id, function (data) {
			that.view.render('showEntries', data);
		});
	};
